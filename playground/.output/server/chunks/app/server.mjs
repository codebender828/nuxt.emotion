import { getCurrentInstance, version, defineComponent, computed, ref, h, resolveComponent, reactive, createApp, toRef, isRef, defineAsyncComponent, provide, onErrorCaptured, unref, useSSRContext, inject } from 'vue';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderAttrs, ssrRenderClass } from 'vue/server-renderer';
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.10499359.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
